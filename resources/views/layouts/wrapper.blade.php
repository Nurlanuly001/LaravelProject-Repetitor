                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center slider-text">
                                <div class="slider-text-inner">
                                    <h1>Учитесь на Отлично,</h1>
                                    <h2>Занимаясь онлайн с личным преподавателем на уникальной платформе школы Репетитор!</h2>
                                    <p><a class="btn btn-primary btn-lg" href="#">Попробовать бесплатно!</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">Бизнес</a></h3>
                            <p>Навык который помогает рости и масштабироваться Вашей компании.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">Здоровья & Психология</a></h3>
                            <p>Дисциплина «Психология здоровья» ставит своей задачей познакомить студента с многообразием взглядов на здоровье.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">Бухгалтерский учет</a></h3>
                            <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">Наука & Технологии</a></h3>
                            <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">Искусство &  Медиа</a></h3>
                            <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <h3><a href="#">SMM &amp; Программирование</a></h3>
                            <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
                        </div>
                    </div>
                </div>
