                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center slider-text">
                                <div class="slider-text-inner">
                                    <h1 class="heading-section">Стоимость уроков</h1>
                                    <h2>Занятия ведут кандидаты наук, учителя первой и высшей категории, эксперты ЕГЭ, специалисты по подготовке к олимпиадам.
                                        Только 5 из 100 кандидатов в репетиторы проходят наш отбор.</h2>
                                </div>
                            </div>
                        </div>
                    </div>
